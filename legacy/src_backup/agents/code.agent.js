...
Provide a complete, actionable response with code examples.`;
  ...
  static canHandle(task) {
    const triggers = [
      ...
      'create a function', 'code for', 'function for', 'how to code',
      'debug', 'fix bug', 'fix this code', 'fix the error',
      'review code', 'refactor', 'unit test', 'write test',
      'algorithm', 'programming',
      '.js code', '.py code', '.ts code',
      'javascript function', 'python script', 'typescript code',
