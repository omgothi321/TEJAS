...
<title>Tejas — Tejas Dashboard</title>
<style>
...
<div class="auth-screen" id="auth-screen">
  <div class="auth-box">
    <h2>⬡ TEJAS</h2>
    <p>Tejas Dashboard — Secure Access</p>
...
<div class="main" id="main">
  ...
  <div class="header">
    <div class="logo">⬡ TEJAS <span></span></div>
  ...
  <div class="grid-2" style="padding: 0 24px 40px">
    <div class="card" style="border-color: #7c3aed44">
      <h3>🎙️ Voice Interface — Tejas Mode</h3>
...
async function speakStatus() {
  ...
  speakText(\`Tejas status. \${tasks} tasks completed. \${nodes} knowledge nodes in memory. All systems operational.\`);
}
