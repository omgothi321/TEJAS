...
Return:
{
  "action": "read|find|summarize|analyze|list|organize|write",
  "target": "filename, directory, or search pattern — extracted from task",
...
Provide the result or explain what you would do.`;
  ...
  static canHandle(task) {
    const triggers = [
      'read', 'open file', 'analyze file', 'summarize',
      'find file', 'list files', 'organize', 'directory',
      'folder', 'what is in', 'show me', 'check file',
      '.js', '.py', '.json', '.md', '.txt', '.sh'
    ];
